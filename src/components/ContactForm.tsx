        ...
        <div className="w-full max-w-md bg-[#0B1121] rounded-xl overflow-hidden relative">
          <div className="p-6">
            ...
            <div className="text-center mb-6">
              <h2 className="text-2xl font-bold text-white">Book Your Visa Slot</h2>
              <p className="text-gray-400 mt-1">Share your details and we'll contact you shortly</p>
            </div>
              ...
              <div className="space-y-4">
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-[#1A2333] border border-gray-700 rounded-lg pl-10 pr-4 py-2 text-white placeholder-gray-400 focus:border-yellow-400 focus:ring-1 focus:ring-yellow-400"
                  />
                </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full bg-[#1A2333] border border-gray-700 rounded-lg pl-10 pr-4 py-2 text-white focus:border-yellow-400 focus:ring-1 focus:ring-yellow-400"
                    />
                  </div>
                  <div className="relative">
                    <Calendar className="absolute left-3 top-3 w-5 h-5 text-gray-400" />
